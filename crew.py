...
from agents.legal_precedent_agent import legal_precedents_agent
...
from tasks.legal_precedent_task import legal_precedents_task
from tasks.legal_drafter_task import legal_drafter_task


legal_assistant_crew = Crew(
    agents=[case_intake_agent,ipc_section_agent,legal_precedents_agent,legal_drafter_agent],
    tasks=[case_intake_task,ipc_section_task,legal_precedents_task,legal_drafter_task],
    verbose=True
)
